...
# Version de l'agent. 1.2.0 : collecte enrichie des correctifs Windows en attente
# (KB, titre, sévérité, taille, type, redémarrage requis) pour la gestion des
# correctifs. 1.1.3 : écoute du son système du poste (WASAPI loopback,
